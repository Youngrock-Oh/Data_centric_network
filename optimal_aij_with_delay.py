...
def optimal_aij(Lambdas, Mus, Deltas, Initial, eps1, eps2, t0, m, alpha, beta):
    ...
    service_time = 0
    for i in range(Nl):
        service_time += lambda_hats[i]/(mus[i]-lambda_hats[i])
    
    return A, lambda_hats, service_time     
        
A, lambda_hats, service_time = optimal_aij([2,1], [2.2,2,1.8], [[5,0,0],[0,0,0]], [[1/4,1/4,1/2],[1/5,2/5,2/5]], 0.0000001, 0.0000001, 1, 1.01, 0.01, 0.1)        
print(A)
print(lambda_hats)
print(service_time)        
